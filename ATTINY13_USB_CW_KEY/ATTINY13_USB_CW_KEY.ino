...
// обрабатываем нажатие манипулятора "точка"
  if(digitalRead(CW_DIT_PIN) == 0 || dit_on == 1) {
    ...
    t_delay = analogRead(CW_SPEED_PIN)*(MAX_DIT_TIME - MIN_DIT_TIME)/1023 + MIN_DIT_TIME;  // 1023
